package com.xiaoshangxing.wo.setting.privacy.shieldListFragment;
 ...
 */
public class ShieldListFragment extends BaseFragment implements View.OnClickListener, IBaseView {
    ...
    private void upload(final List<String> add, final List<String> remove) {
        ...
        if (!add.isEmpty() && !remove.isEmpty()) {
            OperateUtils.SchoolCirclrPermisson(add, NS.MY_BLOCK_CODE, this, new SimpleCallBack() {
                @Override
                public void onSuccess() {
                    OperateUtils.SchoolCirclrPermisson(remove, NS.REMOVE_MY_BLOCK_CODE, ShieldListFragment.this, simpleCallBack);
                }

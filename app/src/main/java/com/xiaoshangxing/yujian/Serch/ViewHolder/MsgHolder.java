...
import com.xiaoshangxing.yujian.Serch.MsgItem;
...
public class MsgHolder extends AbsContactViewHolder<MsgItem> {
    ...
    public View inflate(LayoutInflater inflater) {
        ...
        if (parent.getMeasuredWidth() == 0) {
            ...
            parent.measure(View.MeasureSpec.makeMeasureSpec(ScreenUtils.getDisplayWidth() - ScreenUtils.dip2px(50.0f), View.MeasureSpec.EXACTLY), 0);
        }

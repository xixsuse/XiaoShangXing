package com.xiaoshangxing.yujian.IM.kit.ImageKit.imageview;
...
public class HeadImageView extends CircleImageView {
    ...
    public static final int DEFAULT_AVATAR_THUMB_SIZE =
            (int) NimUIKit.getContext().getResources().getDimension(R.dimen.avatar_max_size);
    public static final int DEFAULT_AVATAR_NOTIFICATION_ICON_SIZE =
            (int) NimUIKit.getContext().getResources().getDimension(R.dimen.avatar_notification_size);
    ...
    public void loadTeamIconByTeam(final Team team) {
        // 先显示默认头像
        setImageResource(R.mipmap.cirecleimage_default);

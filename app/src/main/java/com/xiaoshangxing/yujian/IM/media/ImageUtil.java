package com.xiaoshangxing.yujian.IM.media;
...
public class ImageUtil {
    ...
    public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(NimUIKit.getContext().getResources(), R.mipmap.nim_image_download_failed);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String makeThumbnail(Context context, File imageFile) {
        ...
        boolean result = scaleThumbnail(
                imageFile,
                thumbFile,
                (int) (165.0 / 320.0 * ScreenUtils.screenWidth),
                (int) (76.0 / 320.0 * ScreenUtils.screenWidth),
                CompressFormat.JPEG,
                60);
        if (!result) {

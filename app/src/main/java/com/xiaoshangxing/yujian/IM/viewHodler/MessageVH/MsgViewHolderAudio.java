...
import com.xiaoshangxing.yujian.IM.kit.audioplayer.Playable;
...
public class MsgViewHolderAudio extends MsgViewHolderBase {
    ...
    private void layoutByDirection() {
        if (isReceivedMessage()) {
            ...
            containerView.setBackgroundResource(R.drawable.message_receive);
            containerView.setPadding(ScreenUtils.dip2px(15), ScreenUtils.dip2px(8), ScreenUtils.dip2px(10), ScreenUtils.dip2px(8));
            ...
            containerView.setBackgroundResource(R.drawable.message_send);
            containerView.setPadding(ScreenUtils.dip2px(10), ScreenUtils.dip2px(8), ScreenUtils.dip2px(15), ScreenUtils.dip2px(8));

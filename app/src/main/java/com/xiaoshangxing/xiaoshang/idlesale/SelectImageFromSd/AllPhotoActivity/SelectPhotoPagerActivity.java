 ...
 * 图片查看器
 */
public class SelectPhotoPagerActivity extends FragmentActivity {
...
//    private TextView indicator;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.idle_image_detail_select);
            ...
            public void onClick(View v) {
                if (checkbox.isChecked()){
                    if (select_image_urls.size() >= limit) {
                        Toast.makeText(SelectPhotoPagerActivity.this, "最多只能选择"+limit+"张图片", Toast.LENGTH_SHORT).show();
...
//        setResult(InputActivity.SELECT_PHOTO_ONE_BY_ONE, intent);
        ...
        k.putStringArrayListExtra("path",select_picture_urls2);
        startActivity(k);

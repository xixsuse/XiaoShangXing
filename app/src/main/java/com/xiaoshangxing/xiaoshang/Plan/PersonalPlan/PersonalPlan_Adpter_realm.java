 ...
 * on 2016/4/20
 */
public class PersonalPlan_Adpter_realm extends RealmBaseAdapter<Published> {
    ...
    public PersonalPlan_Adpter_realm(Context context, RealmResults<Published> objects,

 ...
 * on 2016/4/20
 */
public class RewardCollect_Adpter_realm extends RealmBaseAdapter<Published> {
    ...
    public RewardCollect_Adpter_realm(Context context, RealmResults<Published> objects,

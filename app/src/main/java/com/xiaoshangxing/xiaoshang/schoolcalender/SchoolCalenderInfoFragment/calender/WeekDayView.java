...
public class WeekDayView extends View {
    ...
    //周一到周五的颜色
//	private int mWeedayColor =R.color.b1;
    //周六、周日的颜色
    private int mWeekendColor = getResources().getColor(R.color.b1);
    //线的宽度
...
//		canvas.drawLine(0, height, width, height, paint);
        ...
        for(int i=0;i < weekString.length;i++){
            ...
            int startX;
            if (i==0){
                startX =(columnWidth - fontWidth)/2-20;
            }else {
                startX = columnWidth * i +5*i+(columnWidth - fontWidth)/2;
            }
...
//			}
    ...
    public void setmWeedayColor(int mWeedayColor) {
        this.mWeekendColor = mWeedayColor;
    }

package com.xiaoshangxing.utils.customView.EmotionEdittext.EmotFilter;
...
public class MoonUtil {
    ...
    public static void identifyFaceExpressionAndATags(Context context,
                                                      View textView, String value, int align) {
        SpannableString mSpannableString = makeSpannableStringTags(context, value, DEF_SCALE, align, WRAP_DRAWABLE);
    ...
    public static void identifyFaceExpressionAndTags(Context context,
                                                     View textView, String value, int align, float scale) {
        SpannableString mSpannableString = makeSpannableStringTags(context, value, scale, align, false, WRAP_DRAWABLE);
        viewSetText(textView, mSpannableString);
    }
    ...
    public static SpannableString makeSpannableStringTags(Context context, String value, float scale, int align, int size) {
        return makeSpannableStringTags(context, value, DEF_SCALE, align, true, size);
    }
    ...
    public static SpannableString makeSpannableStringTags(Context context, String value, float scale, int align, boolean bTagClickable, int fontSize) {
        ...
        while (matcher.find()) {
            ...
            if (d != null) {
                ...
                if (fontSize == WRAP_DRAWABLE) {
                    itemHeight = d.getIntrinsicHeight();
                    itemWidth = d.getIntrinsicWidth();
                } else {
                    itemHeight = fontSize;
                    itemWidth = fontSize;
                }
                d.setBounds(0, 0, itemHeight, itemWidth);
    ...
    //	test
    public static Spannable getSpannable(Spannable spannable, Context context, String value, int fontSize) {
//	ArrayList<ATagSpan> tagSpans = new ArrayList<ATagSpan>();
//	if(TextUtils.isEmpty(value)){
//		value="";
//	}
...
//	SpannableString mSpannableString = new SpannableString(value);
        ...
        while (matcher.find()) {
            ...
            String emot = value.substring(start, end);
            Drawable d = getEmotDrawable(context, emot, 0.6f);
            if (d != null) {
                int itemHeight;
                int itemWidth;
                if (fontSize == WRAP_DRAWABLE) {

...
import com.xiaoshangxing.setting.utils.photo_choosing.PhotoView;
...
public class GalleryFragment extends BaseFragment {
    public static final String TAG = BaseFragment.TAG + "-GalleryFragment";
    ...
    private void initListViews(Bitmap bm) {
        ...
        PhotoView img = new PhotoView(getActivity());

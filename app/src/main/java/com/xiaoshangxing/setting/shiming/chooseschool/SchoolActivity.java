...
public class SchoolActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vertify_school);
        ButterKnife.bind(this);

        getCity();

        schools = Arrays.asList(getResources().getStringArray(R.array.date));
        ...
        SourceDateList = filledData(schools);
...
//                Toast.makeText(getApplication(), adapter.getItem(position).getName(), Toast.LENGTH_SHORT).show();
                VertifyShiMingActivity.schoolStr = adapter.getItem(position).getName();
                finish();
            }
        });
